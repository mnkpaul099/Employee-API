...
public class EmployeeController {
    ...
    public Employee addEmployee(@Valid @RequestBody Employee employee) throws ExistingEmployeeException {
        return employeeService.addEmployeeService(employee);
    }
	
	@PutMapping(path = { "/admin/updateEmployee" })
    public Employee updateOrder(@Valid @RequestBody  Employee employee) throws EmployeeNotFoundException {
        return employeeService.updateEmployeeService(employee);
    }
	
	@DeleteMapping({ "/admin/deleteEmployee/{employeeId}" })
    public ResponseEntity<Object> deleteEmployee(@PathVariable("employeeId") long employeeId) throws EmployeeNotFoundException {
